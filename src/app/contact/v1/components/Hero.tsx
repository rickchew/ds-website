              ...
              <Col xs={11} lg={9} className="mx-auto">
                <Card className="shadow p-4 p-sm-5 p-md-6">
                  <CardHeader className="border-bottom px-0 pt-0 pb-5">
                    ...
                    <h1 className="mb-3 h3">Let&apos;s see if we&apos;re a fit.</h1>
                    <p className="mb-0">
                      Tell us where you are in the loop — brand, website, automation, app, IoT, data or AI — and we&apos;ll show you the next step. Reach us at <Link href="mailto:hello@designspace.my">hello@designspace.my</Link> or 016-589 7771. We reply within 1 business day.
                    </p>
                  </CardHeader>
