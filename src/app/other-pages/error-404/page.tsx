        ...
        <section className="pt-8 pt-xl-9">
          <Container>
            <Row className="align-items-center">
              <Col md={9} lg={6} className="text-center mx-auto">
                <figure>
                  <svg
                    version="1.1"
                    ...
                    xmlSpace="preserve">
                    <polygon className="fill-body" points="332.2,56.2 335.4,56.7 332.5,56" />
                    <path
                      className="fill-body"
                      d="M381.2,67.3c0,1.5-0.6,2.9-1.8,3.9c-0.9,0.8-2.2,1.3-3.4,1.3c-0.2,0-0.5,0-0.7,0l-45.8-6.1v244.3h202.3V24.6 H381.2V67.3z"
                    />
                    <polygon className="fill-white" points="370.8,27.6 332.5,56 335.4,56.7 370.8,61.4 			" />
                    <polygon className="fill-primary opacity-4" points="370.8,27.6 332.5,56 335.4,56.7 370.8,61.4 			" />
                    <path
                      className="fill-mode"
                    ...
                    />
                    <polygon className="fill-white" points="552,367 301,340.8 315.6,220.8 566.5,246.9" />
                    <polygon className="fill-primary opacity-4" points="552,367 301,340.8 315.6,220.8 566.5,246.9" />
                    <path
                      className="fill-mode"
