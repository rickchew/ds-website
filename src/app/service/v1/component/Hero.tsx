      ...
      <Container className="position-relative z-index-1">
        <Row className="g-4 g-xxl-5">
          <Col lg={8} className="text-center mx-auto">
            ...
            <h1 className="mb-0 text-white">Seven pillars. One connected studio.</h1>
            <p className="text-white mt-3 mb-0">Brand · AI-Ready Website · Automation · Custom App · IoT · Data Intelligence · AI Lab.</p>
          </Col>
        </Row>
      </Container>
    </section>
