            ...
            <div className="pe-xxl-4">
              ...
              <h1 className="mt-3 lh-base">
                ...
                <span className="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
                  <ReactTyped strings={['Web Design', 'Web Dev', 'UI/UX Design']} className="typed" typeSpeed={200} backSpeed={50} loop />
                </span>
              </h1>
              <p className="mb-0 mt-4 mt-md-5">
                From concept to execution, we deliver web designs that make an impact. Let your brand shine with our innovative and visually stunning
                websites.
              </p>
