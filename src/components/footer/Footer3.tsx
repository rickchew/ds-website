      ...
      <Container className="position-relative mt-5">
        <Row className="g-4">
          ...
          <Col xs={6} md={4} lg={5} xl={4}>
            <h6 className="mb-2 mb-md-4">Site</h6>
            <Row className="g-0">
              <Col lg={6}>
          ...
          <Col xs={6} md={4} lg={3} xl={2}>
            <h6 className="mb-2 mb-md-4">More services</h6>
            <ul className="nav flex-column">
          ...
          <Col sm={6} md={4} lg={4} xl={3}>
            <h6 className="mb-2 mb-md-4">Get started</h6>
              ...
              return (
                <div key={item.title + idx} className="position-relative d-flex align-items-center py-2 my-2">
                  ...
                  <div className="nav flex-column ps-3">
                    ...
                    <div className="small text-body-secondary">{item.title === 'Explore Services' ? 'Seven pillars · one connected loop' : item.title === 'Case Studies' ? 'Real work · real industries' : 'Tell us where you are in the loop'}</div>
                  </div>
                </div>
              )
            })}
        ...
        <Row className="g-4 align-items-center">
          <Col xl={3} className="text-lg-center text-xl-start mb-4 mb-xl-0">
            ...
            <p className="mb-0">We reply within 1 business day.</p>
          </Col>
